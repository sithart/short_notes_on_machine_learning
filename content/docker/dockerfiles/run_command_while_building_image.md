---
title: "Run Command While Building Image"
date: 2020-07-22T00:00:00-07:00
description: "Run command while building image using Dockerfiles."
type: technical_note
draft: False
---
...
`RUN` executes a command while building an image from a Dockerfile.

`CMD` executes a command while building a container from an image.
...
Build the Dockerfile (`docker build`) in the current directory (`.`) and call the image chrisalbon/ubuntu:with-git (`--tag chrisalbon/ubuntu:with-git`).

{{< highlight bash >}}
docker build --tag chrisalbon/ubuntu:with-git .
{{< /highlight >}}
```
Sending build context to Docker daemon  2.048kB
Step 1/3 : FROM ubuntu:latest
 ---> 1e4467b07108
Step 2/3 : LABEL maintainer="coder@chrisalbon.com"
 ---> Running in 814394e1a88e
Removing intermediate container 814394e1a88e
 ---> 74a6f636b9c1
Step 3/3 : RUN apt-get update && apt-get install -y git
 ---> Running in 332d2ee6ddc8
...
Get:5 http://security.ubuntu.com/ubuntu focal-security/universe amd64 Packages [62.9 kB]
Get:6 http://security.ubuntu.com/ubuntu focal-security/multiverse amd64 Packages [1078 B]
Get:7 http://security.ubuntu.com/ubuntu focal-security/main amd64 Packages [200 kB]
...
Get:14 http://archive.ubuntu.com/ubuntu focal-updates/universe amd64 Packages [193 kB]
Get:15 http://archive.ubuntu.com/ubuntu focal-updates/restricted amd64 Packages [39.1 kB]
Get:16 http://archive.ubuntu.com/ubuntu focal-updates/main amd64 Packages [417 kB]
Get:17 http://archive.ubuntu.com/ubuntu focal-backports/universe amd64 Packages [3216 B]
Fetched 14.4 MB in 3s (4795 kB/s)
...
The following NEW packages will be installed:
  ...
  libx11-6 libx11-data libxau6 libxcb1 libxdmcp6 libxext6 libxmuu1 netbase
  openssh-client openssl patch perl perl-modules-5.30 publicsuffix xauth
0 upgraded, 56 newly installed, 0 to remove and 4 not upgraded.
...
Get:51 http://archive.ubuntu.com/ubuntu focal-updates/main amd64 libcurl3-gnutls amd64 7.68.0-1ubuntu2.1 [231 kB]
...
Fetched 19.7 MB in 3s (6381 kB/s)
...
Preparing to unpack .../50-libcurl3-gnutls_7.68.0-1ubuntu2.1_amd64.deb ...
Unpacking libcurl3-gnutls:amd64 (7.68.0-1ubuntu2.1) ...
...
Removing intermediate container 332d2ee6ddc8
 ---> 4324a9b33252
Successfully built 4324a9b33252
Successfully tagged chrisalbon/ubuntu:with-git
```