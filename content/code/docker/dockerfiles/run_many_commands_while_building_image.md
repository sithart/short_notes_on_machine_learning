---
title: "Run Many Commands While Building Image"
date: 2020-07-22T00:00:00-07:00
description: "Run many commands while building image using Dockerfiles."
type: technical_note
draft: False
---
...
## Create Dockerfile
 ...
 A new image layer is created every time `RUN` is executed, therefore it is most often advisable to chain build steps using `&&`.
...
RUN apt-get update \
    ...
    && touch secret_project/project_alpha.txt \
    && touch secret_project/project_beta.txt \
    && touch secret_project/project_delta.txt \
    && touch secret_project/project_omega.txt \
{{< /highlight >}}

## Build Image From Dockerfile

Build the Dockerfile (`docker build`) in the current directory (`.`) and call the image chrisalbon/ubuntu:many-commands (`--tag chrisalbon/ubuntu:many-commands`).

{{< highlight bash >}}
docker build --tag chrisalbon/ubuntu:many-commands .
{{< /highlight >}}
```
Sending build context to Docker daemon  4.608kB
Step 1/2 : FROM ubuntu:latest
 ---> 1e4467b07108
Step 2/2 : RUN apt-get update     && apt-get install -y git     && touch config.txt     && mkdir secret_project     && touch secret_project/project_alpha.txt     && touch secret_project/project_beta.txt     && touch secret_project/project_delta.txt     && touch secret_project/project_omega.txt
 ---> Running in 6e2cf592c9ea
...
Get:5 http://security.ubuntu.com/ubuntu focal-security/main amd64 Packages [203 kB]
Get:6 http://security.ubuntu.com/ubuntu focal-security/restricted amd64 Packages [39.1 kB]
...
Get:13 http://archive.ubuntu.com/ubuntu focal-updates/universe amd64 Packages [195 kB]
Get:14 http://archive.ubuntu.com/ubuntu focal-updates/multiverse amd64 Packages [17.3 kB]
Get:15 http://archive.ubuntu.com/ubuntu focal-updates/restricted amd64 Packages [39.3 kB]
Get:16 http://archive.ubuntu.com/ubuntu focal-updates/main amd64 Packages [420 kB]
Get:17 http://archive.ubuntu.com/ubuntu focal-backports/universe amd64 Packages [3216 B]
Fetched 14.4 MB in 8s (1799 kB/s)
...
The following NEW packages will be installed:
  ...
  libx11-6 libx11-data libxau6 libxcb1 libxdmcp6 libxext6 libxmuu1 netbase
  openssh-client openssl patch perl perl-modules-5.30 publicsuffix xauth
0 upgraded, 56 newly installed, 0 to remove and 5 not upgraded.
...
Get:4 http://archive.ubuntu.com/ubuntu focal/main amd64 libperl5.30 amd64 5.30.0-9build1 [3943 kB]
...
Get:7 http://archive.ubuntu.com/ubuntu focal/main amd64 openssl amd64 1.1.1f-1ubuntu2 [621 kB]
Get:8 http://archive.ubuntu.com/ubuntu focal-updates/main amd64 ca-certificates all 20190110ubuntu1.1 [145 kB]
...
Get:14 http://archive.ubuntu.com/ubuntu focal/main amd64 krb5-locales all 1.17-6ubuntu4 [11.4 kB]
...
Get:18 http://archive.ubuntu.com/ubuntu focal/main amd64 libkrb5support0 amd64 1.17-6ubuntu4 [30.9 kB]
Get:19 http://archive.ubuntu.com/ubuntu focal/main amd64 libk5crypto3 amd64 1.17-6ubuntu4 [80.2 kB]
Get:20 http://archive.ubuntu.com/ubuntu focal/main amd64 libkeyutils1 amd64 1.6-6ubuntu1 [10.2 kB]
Get:21 http://archive.ubuntu.com/ubuntu focal/main amd64 libkrb5-3 amd64 1.17-6ubuntu4 [330 kB]
Get:22 http://archive.ubuntu.com/ubuntu focal/main amd64 libgssapi-krb5-2 amd64 1.17-6ubuntu4 [121 kB]
...
Get:27 http://archive.ubuntu.com/ubuntu focal/main amd64 libx11-data all 2:1.6.9-2ubuntu1 [113 kB]
Get:28 http://archive.ubuntu.com/ubuntu focal/main amd64 libx11-6 amd64 2:1.6.9-2ubuntu1 [573 kB]
...
Get:31 http://archive.ubuntu.com/ubuntu focal-updates/main amd64 openssh-client amd64 1:8.2p1-4ubuntu0.1 [672 kB]
...
Get:34 http://archive.ubuntu.com/ubuntu focal/main amd64 libbrotli1 amd64 1.0.7-6build1 [270 kB]
...
Get:46 http://archive.ubuntu.com/ubuntu focal-updates/main amd64 libldap-common all 2.4.49+dfsg-2ubuntu1.3 [17.0 kB]
Get:47 http://archive.ubuntu.com/ubuntu focal-updates/main amd64 libldap-2.4-2 amd64 2.4.49+dfsg-2ubuntu1.3 [155 kB]
...
Get:51 http://archive.ubuntu.com/ubuntu focal-updates/main amd64 libcurl3-gnutls amd64 7.68.0-1ubuntu2.2 [231 kB]
Get:52 http://archive.ubuntu.com/ubuntu focal/main amd64 liberror-perl all 0.17029-1 [26.5 kB]
Get:53 http://archive.ubuntu.com/ubuntu focal/main amd64 git-man all 1:2.25.1-1ubuntu3 [884 kB]
Get:54 http://archive.ubuntu.com/ubuntu focal/main amd64 git amd64 1:2.25.1-1ubuntu3 [4554 kB]
...
Fetched 19.7 MB in 8s (2429 kB/s)
...
Preparing to unpack .../13-krb5-locales_1.17-6ubuntu4_all.deb ...
...
Preparing to unpack .../17-libkrb5support0_1.17-6ubuntu4_amd64.deb ...
Unpacking libkrb5support0:amd64 (1.17-6ubuntu4) ...
Selecting previously unselected package libk5crypto3:amd64.
Preparing to unpack .../18-libk5crypto3_1.17-6ubuntu4_amd64.deb ...
...
Preparing to unpack .../20-libkrb5-3_1.17-6ubuntu4_amd64.deb ...
Unpacking libkrb5-3:amd64 (1.17-6ubuntu4) ...
Selecting previously unselected package libgssapi-krb5-2:amd64.
Preparing to unpack .../21-libgssapi-krb5-2_1.17-6ubuntu4_amd64.deb ...
...
Preparing to unpack .../26-libx11-data_2%3a1.6.9-2ubuntu1_all.deb ...
Unpacking libx11-data (2:1.6.9-2ubuntu1) ...
Selecting previously unselected package libx11-6:amd64.
Preparing to unpack .../27-libx11-6_2%3a1.6.9-2ubuntu1_amd64.deb ...
...
Preparing to unpack .../30-openssh-client_1%3a8.2p1-4ubuntu0.1_amd64.deb ...
...
Preparing to unpack .../33-libbrotli1_1.0.7-6build1_amd64.deb ...
...
Preparing to unpack .../45-libldap-common_2.4.49+dfsg-2ubuntu1.3_all.deb ...
Unpacking libldap-common (2.4.49+dfsg-2ubuntu1.3) ...
Selecting previously unselected package libldap-2.4-2:amd64.
Preparing to unpack .../46-libldap-2.4-2_2.4.49+dfsg-2ubuntu1.3_amd64.deb ...
...
Preparing to unpack .../50-libcurl3-gnutls_7.68.0-1ubuntu2.2_amd64.deb ...
...
Preparing to unpack .../52-git-man_1%3a2.25.1-1ubuntu3_all.deb ...
Unpacking git-man (1:2.25.1-1ubuntu3) ...
Selecting previously unselected package git.
Preparing to unpack .../53-git_1%3a2.25.1-1ubuntu3_amd64.deb ...
...
Removing intermediate container 6e2cf592c9ea
 ---> 86915597532f
Successfully built 86915597532f
Successfully tagged chrisalbon/ubuntu:many-commands
```